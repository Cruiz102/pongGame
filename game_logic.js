class GameLogic{
    ...
    hitBallLogic(p1,ball,p2){
        ...
        this.offsetP2 = createVector(ball.position.x -p2.x, ball.position.y - (p2.y + 150/2)).normalize()
        ...
        this.offsetP1 = createVector(ball.position.x -p2.x, ball.position.y - (p2.y + 150/2)).normalize()
